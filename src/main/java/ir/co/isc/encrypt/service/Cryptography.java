...
public interface Cryptography {
    ...
    List<Agent> decrypt(List<AgentDto> agentDtos) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException;
